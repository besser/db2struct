...
func Generate(columnTypes map[string]map[string]string, tableName string, structName string, pkgName string, dbAnnotation, jsonAnnotation, gormAnnotation, gureguTypes bool) ([]byte, error) {
	var dbTypes string
	dbTypes = generateMysqlTypes(columnTypes, 0, dbAnnotation, jsonAnnotation, gormAnnotation, gureguTypes)
